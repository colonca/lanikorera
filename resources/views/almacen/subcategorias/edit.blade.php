...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
        ...
        <li class="active"><a href="{{route('subcategorias.index')}}">Subcategoría</a></li>
        <li class="active"><a href="">Editado Subcategoría {{$subcategoria->nombre}}</a></li>
    </ol>
@endsection
@section('style')
    <style>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <br/><input type="text" class="form-control" placeholder="Escriba el nombre de la ubcategoria" value="{{$subcategoria->nombre}}" name="nombre" required />
                                    </div>
                                    <div class="form-line">
                                        <label for="exampleFormControlSelect1">Descripción</label>
                                        <br/><input type="text" class="form-control" placeholder="Escriba la descripcion de la categoria" value="{{$subcategoria->descripcion}}" name="descripcion"  />
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-brown">
            ...
            <div class="modal-body">
                <strong>Agregue nuevas Subcategorías</strong>
            </div>
