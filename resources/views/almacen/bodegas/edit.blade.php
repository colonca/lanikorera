...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
        ...
        <li class="active"><a href="{{route('bodegas.index')}}">Bodegas</a></li>
        <li class="active"><a href="">Editado bodega {{$bodega->nombre}}</a></li>
    </ol>
@endsection
@section('content')
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                   Editando Bodega - MÓDULO ALMACEN DEL SISTEMA
                </h2>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-brown">
            ...
            <div class="modal-body">
                <strong>Agregue nuevas bodegas</strong>
            </div>
