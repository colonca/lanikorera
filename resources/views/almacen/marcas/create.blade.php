...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
        ...
        <li class="active"><a href="">Creando una nueva marca</a></li>
    </ol>
@endsection
@section('content')
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    MARCAS DE LOS PRODUCTOS - MÓDULO ALMACEN DEL SISTEMA
                </h2>
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('marcas.store')}}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input type="text" class="form-control" placeholder="Escriba el nombre de la marca" name="nombre" required="required" />
                                    </div>
                                </div>
                                <div class="form-group">
