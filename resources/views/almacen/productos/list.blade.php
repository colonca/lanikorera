...
<ol class="breadcrumb" style="margin-bottom: 30px; background-color: #38383A">
    ...
    <li class="active"><a style="color:white" href="">Productos</a></li>
</ol>
@endsection
@section('content')
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    DATOS DEL ALMACEN - PRODUCTOS EN EL SISTEMA.<small>Haga clic en el botón de 3 puntos de la derecha de este título para agregar un nuevo registro.</small>
                </h2>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="{{ route('productos.delete',$producto->id)}}"
                                       ...
                                       data-placement="top" title="Eliminar Producto"><i
