...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    DATOS DEL ALMACEN - CATEGORÍAS EN EL SISTEMA.<small>Haga clic en el botón de 3 puntos de la derecha de este título para agregar un nuevo registro.</small>
                </h2>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="{{ route('categorias.delete',$categoria->id)}}"
                                       ...
                                       data-placement="top" title="Eliminar Categoria"><i
